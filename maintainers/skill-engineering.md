...
Default reasoning: `high`. Use subagents only for independent Keystone-maintenance slices and contract audits; escalate to `xhigh` when routing, public entrypoint, or packaging semantics change.
